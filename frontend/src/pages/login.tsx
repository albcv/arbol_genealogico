...
export function Login() {
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // El token se guarda en cookie HttpOnly, solo guardamos el usuario en el contexto
      login(data.user);
      navigate('/inicio');
    } catch (err: any) {
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`pl-10 w-full px-4 py-3 border ${theme.inputBorder} rounded-lg ${theme.inputFocusRing} focus:border-transparent transition-all duration-300 placeholder-slate-600`}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`pl-10 pr-12 w-full px-4 py-3 border ${theme.inputBorder} rounded-lg ${theme.inputFocusRing} focus:border-transparent transition-all duration-300 placeholder-slate-600`}
