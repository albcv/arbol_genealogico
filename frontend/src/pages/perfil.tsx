      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            {/* Profile Header */}
            <div className="bg-gradient-to-r from-green-800 to-green-600 p-8">
              <div className="flex flex-col md:flex-row items-center">
                <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mb-6 md:mb-0 md:mr-8">
                  <span className="text-green-800 font-bold text-3xl">{iniciales}</span>
                </div>
                <div className="text-center md:text-left">
                  <h2 className="text-3xl font-bold text-white">{userData.username}</h2>
                  <p className="text-green-100 mt-2">{userData.email}</p>
                  <p className="text-green-100 text-sm mt-1">Miembro desde: {userData.date_joined}</p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl p-8 max-w-md w-full">
            ...
            <form onSubmit={handlePasswordSubmit}>
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-700 text-white rounded-lg hover:from-green-700 hover:to-emerald-800 transition-all"
                >
                  Cambiar Contraseña
                </button>
              </div>
